...
#   - using gcc -mdll instead dllwrap doesn't work without -assets because
#     it tries to link against dlls instead their import libraries. (If
#     it finds the dll first.)
#     By specifying -assets we force ld to link against the import libraries,
