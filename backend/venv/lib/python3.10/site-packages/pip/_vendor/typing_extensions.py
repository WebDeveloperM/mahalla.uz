...
# 3.6.0-3.6.1
    ...
    class _NoReturn(typing._FinalTypingBase, _root=True):
        ...
        will fail in assets type checkers.
        """
        __slots__ = ()
...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        Such classes are primarily used with assets type checkers that recognize
        structural subtyping (assets duck-typing), for example::
            ...
            func(C())  # Passes assets type check
